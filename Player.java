...
public class Player{
    ...
    public void storeAtHome(int peaches) {
        // ensure player is at Home location
        if (this.location.position.getX() == 0 && this.location.position.getY() == 0) {
            // ensure the amount of peaches they want to drop off does not exceed player's inventory
            if (peaches <= this.peaches.size()) {
    ...
    public void retrieveFromHome(int peaches) {
        ...
        if (this.location.position.getX() == 0 && this.location.position.getY() == 0) {
            if (this.world.home.peaches.containsKey(this)) {
                // ensure the amount of peaches they want to retrieve does not exceed player's inventory
                if (peaches <= this.world.home.peaches.get(this).size()) {
                    for (int i = 0; i < peaches; i++) {
